...
public class WebCoffeeValidationExcepton extends RuntimeException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   */
  public WebCoffeeValidationExcepton() {
    super();
  }
   ...
   */
  public WebCoffeeValidationExcepton(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public WebCoffeeValidationExcepton(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public WebCoffeeValidationExcepton(Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.7
   */
  protected WebCoffeeValidationExcepton(String message, Throwable cause, boolean enableSuppression,
